...
const description =
  "Пробные экзамены ЕГЭ и ОГЭ по всем предметам в условиях реального экзамена: наблюдатели, бланки, тайминг. Проверка экспертами по критериям ФИПИ и разбор ошибок. м. Петроградская.";
